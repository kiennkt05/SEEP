...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--trial', default='CUB_20task', type=str)
    ...
    subparsers.add_argument('--output_dir', default='./output_Cub_20task', help='path where to save, empty for no saving')
