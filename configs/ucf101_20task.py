...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--trial', default='UCF_20task', type=str)
    ...
    # Data parameters
    subparsers.add_argument('--data-path', default='/kaggle/input/datasets/nguyntrungkinkin/ucf101', type=str, help='dataset path')
    ...
    subparsers.add_argument('--output_dir', default='./output_UCF_20task', help='path where to save, empty for no saving')
