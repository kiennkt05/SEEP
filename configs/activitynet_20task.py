...
def get_args_parser(subparsers):
    subparsers.add_argument('--batch-size', default=72, type=int, help='Batch size per device')
    ...
    subparsers.add_argument('--trial', default='Anet_20task', type=str)
    subparsers.add_argument('--D1', default=28, type=int, )
    subparsers.add_argument('--D2', default=56, type=int, )
    subparsers.add_argument('--relation_type', default='attention', type=str)
    subparsers.add_argument('--use_linear', type=lambda x: bool(strtobool(x)), default=True)
    subparsers.add_argument('--balancing', default=0.01, type=float)
    subparsers.add_argument('--warm_up', default=5, type=int)
    ...
    subparsers.add_argument('--opt-eps', default=1e-08, type=float, metavar='EPSILON',
    ...
    subparsers.add_argument('--warmup-lr', type=float, default=1e-06, metavar='LR',
                            help='warmup learning rate (default: 1e-6)')
    subparsers.add_argument('--min-lr', type=float, default=1e-05, metavar='LR',
    ...
    # Data parameters
    subparsers.add_argument('--data-path', default='/kaggle/input/datasets/nguyntrungkinkin/activitynet', type=str, help='dataset path')
    ...
    subparsers.add_argument('--output_dir', default='./output_Anet_20task', help='path where to save, empty for no saving')
    ...
    subparsers.add_argument('--num_tasks_to_run', default=0, type=int, help='number of tasks to run (0 for all)')
    ...
    # LGSP parameters
    subparsers.add_argument('--lgsp', default='YES', type=str, choices=['YES', 'NO'], help='Whether using LGSP or not')
    ...
    # Misc parameters
    subparsers.add_argument('--print_freq', type=int, default=200, help='The frequency of printing')
