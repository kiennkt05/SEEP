...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--trial', default='CIFAR_20task', type=str)
    ...
    subparsers.add_argument('--output_dir', default='./output_Cifar_20task', help='path where to save, empty for no saving')
    ...
    # Misc parameters
    subparsers.add_argument('--print_freq', type=int, default=100, help='The frequency of printing')
