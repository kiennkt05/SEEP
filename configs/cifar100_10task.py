...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--trial', default='CIFAR_10task', type=str)
    ...
    subparsers.add_argument('--output_dir', default='./output_Cifar_10task', help='path where to save, empty for no saving')
