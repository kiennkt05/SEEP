...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--trial', default='Anet_10task', type=str)
    subparsers.add_argument('--D1', default=56, type=int, )
    subparsers.add_argument('--D2', default=96, type=int, )
    ...
    subparsers.add_argument('--output_dir', default='./output_Anet_10task', help='path where to save, empty for no saving')
